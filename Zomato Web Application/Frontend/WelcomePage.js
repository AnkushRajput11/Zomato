  ...
  fetch(
    ...
    .then((dbdata) => {
      ...
      if (dbdata != null) {
        ...
        window.location.replace("HomePage.html?userid=" + dbdata.id);
      } else {
...
document.getElementById("add-rest-div").addEventListener("click", (event) => {
  let userid = localStorage.getItem("userid");
  if (userid != null) {
    window.location.assign("PartnerWithUs.html?userid=" + userid);
  } else {
    window.location.assign("PartnerWithUs.html");
  }
});
